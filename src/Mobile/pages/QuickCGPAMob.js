          ...
          <div className="department-selection-frame">
            ...
            {[1, 2, 3].map((sem) => (
              <Checkbox
                ...
                value={sem}
                style={{ backgroundColor: 'white', borderColor: 'black', fontSize: '16px' }} // Set background color to white and border color to black
              >
              ...
              <div className="subjects-list">
                ...
                {selectedSemesters.flatMap((sem) =>
                  departments[department].semesters[sem].map((subjectData, index) => (
                    <div
                      key={`${sem}-${index}`}
                      className={`subject ${selectedSubject === subjectData ? 'selected' : ''}`}
                    >
